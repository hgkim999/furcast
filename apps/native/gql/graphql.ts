...
export type WeatherInfoAstronomical = {
  ...
  sunrise: Scalars['DateTime']['output'];
  sunriseRaw: Scalars['Int']['output'];
  sunset: Scalars['DateTime']['output'];
  sunsetRaw: Scalars['Int']['output'];
};
